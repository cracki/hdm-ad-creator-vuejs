...
import { Layers, ArrowLeft, ArrowRight, Loader2, AlertCircle, RefreshCw, Shield, Check } from 'lucide-vue-next'
    ...
    <div class="max-w-5xl mx-auto p-4 sm:p-6 md:p-8">
      <header class="flex items-start gap-4 mb-6">
        ...
        <div class="min-w-0 flex-1">
          <div class="text-[11px] font-semibold uppercase tracking-[0.16em] text-primary">{{ t('smart.stepOf') }} 3 / 4</div>
